...
- [x] Request Cookie클래스 포함하도록 리팩토링
- [x] 로그인 시 보이는 페이지 다르게 하기
  - [x] 로그아웃, 마이페이지 버튼 생성하기
- [x] 토큰을 활용한 사용자 인증
  - [x] 토큰 랜덤 문자열 생성
  - [x] 토큰 클라이언트에 발급하는 응답 생성
  - [x] 인증(Authorization)헤더를 이용한 Client의 요청
- [x] Router에 Request객체를 매개변수로 전달하기
- [x] Logout기능 구현
